...
void Cinkes::CObjectWrapper::ConvertBoxToVertices()
{
	...
	m_RenderObject->m_Vertices = {
		-dimensions[0], -dimensions[1], -dimensions[2],  0.0f, 0.0f,
		 dimensions[0], -dimensions[1], -dimensions[2],  1.0f, 0.0f,
		 dimensions[0],  dimensions[1], -dimensions[2],  1.0f, 1.0f,
		 dimensions[0],  dimensions[1], -dimensions[2],  1.0f, 1.0f,
		-dimensions[0],  dimensions[1], -dimensions[2],  0.0f, 1.0f,
		-dimensions[0], -dimensions[1], -dimensions[2],  0.0f, 0.0f,
