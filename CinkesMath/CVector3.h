...
namespace Cinkes {
	...
	public:
		...
		static CVector3 Abs(const CVector3& a_Value) { return {abs(a_Value[0]),abs(a_Value[1]),abs(a_Value[2])}; }
		...
		static CScalar Length(CVector3 a_Vector) { return a_Vector.Length(); }
		static CScalar Length2(CVector3 a_Vector) { return a_Vector.Length2(); }
